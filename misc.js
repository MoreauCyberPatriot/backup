...
// Script below this line composed by Bryce Wong //
// ------------------------------------------------ //

function q1() {
    var answer = document.getElementById("ans1").value.toLowerCase();
    var hash = $.md5(answer);
    if (hash != null && hash == "c8ba3678bec8490f34d49eb81b4da229") {
...
function q2() {
    ...
    var hash = $.md5(answer);
    if (hash != null && hash == "696fa2c7574fdcc693c03977cc76880f") {
        alert("Correct! The answer was: " + answer);
    }
    else if (answer == "") {
        alert("Please type in an answer.");
...
function q3() {
    ...
    var hash = $.md5(answer);
    if (hash != null && hash == "c5af0543407a6e8ba11db6a69f792014") {
        alert("Correct! The answer was: " + answer);
    }
    else if (answer == "") {
        alert("Please type in an answer.");
...
function q4() {
    ...
    var hash = $.md5(answer);
    if (hash != null && hash == "1f3870be274f6c49b3e31a0c6728957f") {
        alert("Correct! The answer was: " + answer);
    }
    else if (answer == "") {
        alert("Please type in an answer.");
...
function q5() {
    ...
    var hash = $.md5(answer);
    if (hash != null && hash == "1b3231655cebb7a1f783eddf27d254ca") {
        alert("Correct! The answer was: " + answer);
    }
    else if (answer == "") {
        alert("Please type in an answer.");
